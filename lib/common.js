...
(function (__factory, __root) {
  ...
  COMMON.T_LITERAL_TABLE = '0';
  COMMON.T_LITERAL_1 = '1';
  COMMON.T_LITERAL_2 = '2';
  COMMON.T_LITERAL_3 = '3';
  COMMON.T_LITERAL_4 = '4';
  ...
  COMMON.T_BREAK = 'B';
  COMMON.AST_NODES[COMMON.T_BREAK] = [COMMON.AST_LITERAL];

  COMMON.T_CALL = 'c';
  COMMON.AST_NODES[COMMON.T_CALL] = [COMMON.AST_NODE, COMMON.AST_ARGUMENTS];

  COMMON.T_CONTINUE = 'C';
  COMMON.AST_NODES[COMMON.T_CONTINUE] = [COMMON.AST_LITERAL];
  ...
  COMMON.AST_NODES[COMMON.T_FUNC] =
    [COMMON.AST_LITERAL, COMMON.AST_ARGUMENTS, COMMON.AST_NODE];
  ...
  COMMON.T_CATCH = 'H';
  COMMON.AST_NODES[COMMON.T_CATCH] = [COMMON.AST_LITERAL, COMMON.AST_NODE];
  ...
  COMMON.T_DOT_MEMBER = 'm';
  COMMON.AST_NODES[COMMON.T_DOT_MEMBER] = [COMMON.AST_LEFT, COMMON.AST_RIGHT];
  COMMON.T_ARRAY_MEMBER = 'M';
  COMMON.AST_NODES[COMMON.T_ARRAY_MEMBER] = [COMMON.AST_LEFT, COMMON.AST_RIGHT];
  ...
  COMMON.T_LABEL = 'z';
  COMMON.AST_NODES[COMMON.T_LABEL] = [COMMON.AST_LITERAL, COMMON.AST_NODE];
